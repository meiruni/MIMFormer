...
import time
from models.function import extract_image_patches, \
...
if __name__ == '__main__':
    ...
    a = torch.randn([10, 31, 8, 8]).to('cuda:0')
    b = torch.randn([10, 3, 64, 64]).to('cuda:0')
    # c = torch.randn([10, 8, 144, 144])

    model = cross_scale_attention_spe(31, 3, ratio=8).to('cuda:0')
